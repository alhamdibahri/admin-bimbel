            ...
            >
              ...
              <template #action="{item}">
                <td class="py-2">
                    ...
                    <CButton size="sm" color="danger" @click="destroy(item.id_role, item.role)">
...
export default {
  ...
  methods: {
    ...
    destroy(id, data){
      this.$swal({
        title: "Hapus Data",
        text: `Anda Yakin Ingin Menghapus Roles ${data} ini?`,
        icon: "question",
        ...
        confirmButtonText: "Hapus!"
          ...
          if(result.value) {
            ...
            this.axios.delete('roles/destroy/' + id, config)
                .then((response) => {
                  this.getData()
                  this.$notify({
                    group: 'foo',
