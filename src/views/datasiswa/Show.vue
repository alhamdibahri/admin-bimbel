                ...
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> {{ values.siswa ? values.siswa.kategori_kelas.kategori_kelas : '-' }} </td>
                    </tr>
                    <tr>
                      <th scope="row">Kelas</th>
                      <td>{{ values.siswa ? values.siswa.kelas.kelas : '-' }}</td>
                    </tr>
                    <tr>
                      <th scope="row">Sekolah</th>
                      <td>{{ values.siswa.schools ? values.siswa.schools.sekolah : '-' }}</td>
                    </tr>
                  </tbody>
                </table>
              </CTab>
...
export default {
    ...
    return {
      ...
      fields: [
        ...
        { key: 'kategori_kelas', _style:'width:20%;' },
         { key: 'mata_pelajaran', _style:'width:20%;', label: 'Mata Pelajaran' },
        { 
          key: 'show_details', 
          label: 'Action', 
          _style: 'width:25%', 
  ...
  methods:{
    ...
    getData(){
        ...
        this.axios.get('siswa/show/' + this.$route.params.id, config)
        .then((response) => {
    ...
    getDataHistory(){
        ...
        this.axios.get('history_siswa/' + this.$route.params.id, config)
        .then((response) => {
    ...
    show(id){
      this.$router.push({ name: 'Detail History Siswa', params: { id: id } });
    },
    destroy(id, data){
      this.$swal({
        title: "Hapus Data",
        text: `Anda Yakin Ingin Menghapus History Siswa dengan ${data} ini?`,
        icon: "question",
