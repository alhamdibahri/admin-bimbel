                  ...
                  >
                    <template #show_details="{item}">
                      <td class="py-2">
                        ...
                        <CButton size="sm" color="primary" class="ml-1" @click="show(item.id_user, item.role)">
...
export default {
  ...
  methods: {
    ...
    this.axios.get('users/verifikasi/1', config)
        .then((response) => {
    ...
    this.axios.get('users/verifikasi/0', config)
        .then((response) => {
          let values = response.data.values
    ...
    this.axios.get('users/verifikasi/2', config)
        .then((response) => {
          let values = response.data.values
