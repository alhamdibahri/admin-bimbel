            ...
            >
              ...
              <template #action="{item}">
                <td class="py-2">
                    ...
                    <CButton size="sm" color="danger" @click="destroy(item.id_province, item.province)">
...
export default {
  ...
  methods: {
    getData(){
        ...
        this.axios.get('provinces', config)
            .then((response) => {
    ...
    destroy(id, data){
      this.$swal({
        title: "Hapus Data",
        text: `Anda Yakin Ingin Menghapus Provinsi ${data} ini?`,
        icon: "question",
        ...
        confirmButtonText: "Hapus!"
          ...
          if(result.value) {
            ...
            this.axios.delete('provinces/destroy/' + id, config)
                .then((response) => {
                  this.getData()
                  this.$notify({
                    group: 'foo',
