            ...
            >
              ...
              <template #action="{item}">
                <td class="py-2">
                    ...
                    <CButton size="sm" color="danger" @click="destroy(item.id_district, item.district)">
...
export default {
  ...
  methods: {
    getData(){
        ...
        this.axios.get('districts', config)
            .then((response) => {
    ...
    destroy(id, data){
      this.$swal({
        title: "Hapus Data",
        text: `Anda Yakin Ingin Menghapus Kecamatan ${data} ini?`,
        icon: "question",
        ...
        confirmButtonText: "Hapus!"
          ...
          if(result.value) {
            ...
            this.axios.delete('districts/destroy/' + id, config)
                .then((response) => {
                  this.getData()
                  this.$notify({
                    group: 'foo',
