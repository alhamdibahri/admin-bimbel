...
export default {
  ...
  methods: {
    ...
    getData(){
        ...
        this.axios.get('support/school/edit/' + this.$route.params.id, config)
        .then((response) => {
            let values = response.data.values
            this.kabupaten = values.regency_id
            this.kecamatan = values.kecamatan
            this.npsn = values.npsn
            this.nama_sekolah = values.sekolah
            this.bentuk = values.bentuk
            this.status = values.status
            this.alamat = values.alamat
            this.bintang = values.bintang
            this.bujur = values.bujur
          })
          .catch(error => {
            this.$notify({
              group: 'foo',
    ...
    save(){
        ...
        this.axios.patch('support/school/update', formData, config)
        .then((response) => {
